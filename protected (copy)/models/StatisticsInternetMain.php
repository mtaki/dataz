...
/**
 * This is the model class for table "statistics_internet_main".
 *
 * The followings are the available columns in table 'statistics_internet_main':
 * @property string $id
 * @property string $operator_id
 * @property integer $st_year
 * @property integer $st_month
 */
class StatisticsInternetMain extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return StatisticsInternetMain the static model class
	 */
	...
	{
		return 'statistics_internet_main';
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('StatisticsInternetMain', array(
			'criteria'=>$criteria,
		));
	}
