...
<?php $this->beginWidget('system.web.widgets.CClipWidget', array('id'=>'Assigned frequency')); ?>

<?php 
if($model->frequency_application_type_id==5){
$this->renderPartial('_frequencyApplicationLink', array('frequencyApplicationLink'=>$frequencyApplicationLink));
}
if($model->frequency_application_type_id==4){
$this->renderPartial('_frequencyApplicationRadioStation', array('frequencyApplicationRadioStation'=>$frequencyApplicationRadioStation));
}
//if($model->frequency_application_type_id==3){
//$this->renderPartial('_frequencyApplicationEquipment', array('model'=>$model));
//}
else{?>
...
<?php
//if($model->frequency_application_type_id==2){
//$this->renderPartial('_frequencyApplicationLink', array('frequencyApplicationLink'=>$frequencyApplicationLink));
//}
//if($model->frequency_application_type_id==1){
//$this->renderPartial('_frequencyApplicationLink', array('frequencyApplicationLink'=>$frequencyApplicationLink));
//}
?>
<?php $this->endWidget(); ?>
...
<?php $this->endWidget(); ?>
<h1>Application Assignment for &nbsp;&nbsp;<?php echo $model->frequencyType->name;?> &nbsp;&nbsp;Licence</h1>
