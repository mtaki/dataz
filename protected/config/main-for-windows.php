...
return array(
	...
	'components'=>array(
		...
		'dbdata'=>array(
			'class'=>'CDbConnection',
			'connectionString' => 'sqlsrv:server=192.168.1.22; Database=TCRAData',
			'username' => 'sa',
			'password' => '1234',
		),
		'dbcontrol'=>array(
			'class'=>'CDbConnection',
			'connectionString' => 'sqlsrv:server=192.168.1.22; Database=TCRAControl',
		...
		'dbproduct'=>array(
			'class'=>'CDbConnection',
			'connectionString' => 'sqlsrv:server=192.168.1.22; Database=Northwind',
