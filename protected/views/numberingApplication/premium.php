...
<table>
<tr><td colspan='2'>Premium Rate Access Codes
...
<fieldset style="-moz-border-radius: 0.4em;">
  <legend><strong>Preferred (if any) Numbers</strong></legend>
  <table width="800" border="0" cellspacing="0" cellpadding="0">
...
<table>
  <tr>
    <td><br/>Status of the existing Number(s) indicating;<br />Which Number(s) is/are in use:</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table>
  <tr>
    ...
    <td><br/>Reserved Number(s) and your plan for it: </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><?php
	echo $form->hiddenField($a,'numbering_fee_type_id',array('size'=>15,'maxlength'=>50,'value'=>18));
	?>
	<?php
