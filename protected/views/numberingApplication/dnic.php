...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Purpose of the applied Data Network Identification Code(s):</td>
...
<table>
 <tr>
    <td>Planned date for the service to be operational using the applied Data Network Identification Code(s).
    </td>
    <td>&nbsp;
    <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
...
<table>
  <tr>
    <td><br/>Status of the existing Assignments (Indicate which Data Network Identification Code(s) is/are in use), if any:  </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
