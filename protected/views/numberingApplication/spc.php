...
<fieldset style="-moz-border-radius: 0.4em;">
  <legend><strong>Preferred (if any) SPC(s)</strong></legend>
  <table width="800" border="0" cellspacing="0" cellpadding="0">
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Purpose of the applied SPC(s)</td>
...
<table>
  <tr>
    <td><br/>Status of the existing SPC(s) indicating;<br />Which SPC(s) is/are in use:</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table>
  <tr>
    ...
    <td><br/>Reserved SPC(s) and your plan for it: </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
