...
<fieldset style="-moz-border-radius: 0.4em;">
  <legend><strong>Preferred (if any) ISPC(s)</strong></legend>
  <table width="800" border="0" cellspacing="0" cellpadding="0">
	<?php 
	$c=1;
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Purpose of the applied ISPC(s)</td>
...
<table>
 <tr>
    <td>Planned date for the service to be operational using the applied ISPC(s):
    </td>
    <td>&nbsp;
    <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
...
<table>
  <tr>
    <td><br/>Status of the existing ISPC(s) indicating;<br />Which ISPC(s) is/are in use:</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table>
  <tr>
    ...
    <td><br/>Reserved ISPC(s) and your plan for it: </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><?php
	echo $form->hiddenField($a,'numbering_fee_type_id',array('size'=>15,'maxlength'=>50,'value'=>15));
	?>
	<?php
