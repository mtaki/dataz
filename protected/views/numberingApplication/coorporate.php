...
<table>
<tr><td colspan='2'>Corporate Services Network Access Numbers
...
<fieldset style="-moz-border-radius: 0.4em;">
  <legend><strong>Preferred (if any)</strong></legend>
  <table width="800" border="0" cellspacing="0" cellpadding="0">
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Purpose of the applied Numbers</td>
...
<table>
 <tr>
    <td>Planned date for the service to be operational using the applied Numbers:
    </td>
    <td>&nbsp;
    <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
...
<table>
  <tr>
    <td><br/>Status of the existing Numbers indicating;<br />Which Numbers is/are in use:</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td><?php echo $form->textArea($a,'numbers_in_use',array('size'=>15,'maxlength'=>50)); ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table>
  <tr>
    ...
    <td><br/>Reserved Numbers and your plan for it: </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><?php echo $form->textArea($a,'numbers_reserved',array('size'=>15,'maxlength'=>50)); ?></td>
    <td>&nbsp;</td>
...
<table>
  <tr>
    <td><br/>Which networks/operators your network is directly interconnected with, and at
what level of interconnection
</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><?php echo $form->textArea($a,'interconnection',array('size'=>15,'maxlength'=>50)); ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><?php
	echo $form->hiddenField($a,'numbering_fee_type_id',array('size'=>15,'maxlength'=>50,'value'=>17));
	?>
	<?php
