...
<fieldset style="-moz-border-radius: 0.4em;">
  <legend><strong>Preferred (if any) Mobile Network Identification Code(s) applied for Assignment/Reservations</strong></legend>
  <table width="800" border="0" cellspacing="0" cellpadding="0">
	<?php 
	$c=1;
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Purpose of the applied Mobile Network Identification Code(s)</td>
...
<table>
 <tr>
    <td>Planned date for the service to be operational using the applied Mobile Network Identification Code(s)
    </td>
    <td>&nbsp;
    <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
...
<table>
  <tr>
    <td><br/>Status of the existing Assignments (Indicate which Mobile Network Identification Code(s) is/are in use), if any: </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
