...
?>
	...
	<tr><td>Business Plan </td><td><?php
	$app_status=array(""=>"","Accepted"=>"Accepted","Rejected"=>"Rejected"); 
...
<script type=\"text/javascript\" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			...
			name: 'uploadfile',
			data:{entity_id : '$model->id',module : 'licence_application',action_stage : 'Business Plan Analysis'},
...
<div id=\"upload\" ><span>Upload Report<span></div><span id=\"status\" ></span>
<ul id=\"files\"></ul>";
echo $s;
?>
...
<?php $this->endWidget(); ?>
<!--<h1>Licence Application - Business Plan Analysis</h1>-->
<h1><?php echo $model->licenceCategory->name; ?> &nbsp; Application- Business Plan Analysis</h1>
<?php
$tabParameters = array();
