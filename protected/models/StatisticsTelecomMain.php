...
/**
 * This is the model class for table "statistics_telecom_main".
 *
 * The followings are the available columns in table 'statistics_telecom_main':
 * @property string $id
 * @property string $operator_id
 * @property integer $st_year
 * @property integer $st_month
 */
class StatisticsTelecomMain extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return StatisticsTelecomMain the static model class
	 */
	...
	{
		return 'statistics_telecom_main';
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('StatisticsTelecomMain', array(
			'criteria'=>$criteria,
		));
	}
