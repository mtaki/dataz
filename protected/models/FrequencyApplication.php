...
>>>>>>> a1c5e6103c0b63b877998875ffb36672f5ea53a6
		...
		elseif(Yii::app()->controller->action->id=='dispatchList')
			...
			$action= 'view';
		return Yii::app()->createUrl("frequencyApplication/$action",array('id'=>$this->id));
	}
	...
	public function relations()
	{
		...
		return array(
            ...
            'frequencyType'=>array(self::BELONGS_TO, 'FrequencyApplicationType', 'frequency_application_type_id'),
            'frequencyAssignment'=>array(self::HAS_MANY, 'FrequencyApplicationEquipment', 'application_id'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'frequency_application_type_id' => 'Frequency Type',
		);
	}
