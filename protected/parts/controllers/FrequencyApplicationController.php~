	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','evaluationList','evaluation','approvalList','approval','dispatchList','assignmentList','assignment','assignment1'),
				'users'=>array('@'),
			),
	...
	public function actionAssignment()
	{
		...
		if(isset($_POST['FrequencyApplication']))
		{
			...
			if($valid){
				...
				$this->redirect(array('assignmentlList'));
			}
