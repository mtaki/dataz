...
<fieldset style="-moz-border-radius: 0.4em;">
  <legend><strong>Preferred (if any) NCC(s)</strong></legend>
  <table width="800" border="0" cellspacing="0" cellpadding="0">
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Purpose of the applied NCC(s)</td>
...
<table>
 <tr>
    <td>Planned date for the service to be operational using the applied NCC(s):
    </td>
    <td>&nbsp;
    <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
...
<table>
  <tr>
    <td><br/>Status of the existing NCC(s) indicating;<br />Which NCC(s) is/are in use:</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table>
  <tr>
    ...
    <td><br/>Reserved NCC(s) and your plan for it: </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><?php
	echo $form->hiddenField($a,'numbering_fee_type_id',array('size'=>15,'maxlength'=>50,'value'=>16));
	?>
	<?php
