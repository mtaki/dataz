<h1>Numbering Application Certificate Preparation</h1>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<tr><td>Issue Date</td><td colspan='2'>
	<?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
        'name'=>'NumberingApplication[issue_date]',
...
?>
	...
	<tr><td>Certificate No.</td><td colspan='2'>
	<?php echo $form->textField($model,'certificate_number'); ?>
	</td></tr>
...
$url=Yii::app()->createUrl('site/printDocs',array('id'=>$model->id,'file'=>'numbering.rtf.php'));
