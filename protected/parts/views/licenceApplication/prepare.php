...
for ($i=0;$i<5;$i++){
	...
	$html.="<tr><td><input size=10 name='type_$i' value='".$type."'/></td><td><input size=10 name='status_$i' value='".$status."'/>
</td><td><input size=10 name='capacity_$i'  value='".$capacity."'/></td><td><input size=10 name='time_$i' value='".$time."'/></td><td><input size=10 name='area_$i' value='".$area."'/></td></tr>";
}
$html.="</table>";
echo $html;
}
