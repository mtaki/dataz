...
$acs=ApplicationDistribution::model()->with('licenceApplication','licenceApplication.licenceCategory','licenceApplication.applicant','licenceApplication.marketSegment')->findAll(array('condition'=>"t.id=$id"));
foreach ($acs as $ac)
