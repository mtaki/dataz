<script language="javascript">
	...
	function appeal(){
		var a = confirm('Move to committee ?');
		if (a == true){
...
echo $mainTable;
echo $historyTable;
if ($model->stage=='TCRA Action' && $model->status!='Closed'){?>
	<table width='100%' border='0'>
		...
		<tr>
			...
			<td valign='top'>
				...
				<table class='detail-view'>
						...
						<tr class='even'><td><input type='button' value='Move to Committee' onclick='appeal()'/></td></tr>
				</table>
				<input type='hidden' name='entityid' value='$id'/>
